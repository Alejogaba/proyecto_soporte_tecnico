                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: CircularProgressIndicator(
                              color: (snapshot.data!.turno!=null&&snapshot.data!.turno==1)? FlutterFlowTheme.of(context).primary : Color.fromARGB(255, 43, 96, 112),
                            ),
                          ),
                        ),
                        Container(
