...
class ListaFuncionariosWidget extends StatefulWidget {
  ...
  @override
  _ListaFuncionariosWidgetState createState() => _ListaFuncionariosWidgetState();
}
...
class _ListaFuncionariosWidgetState extends State<ListaFuncionariosWidget>
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              if(snapshot
                                                                            .data![index]
                                                                            .email!.toLowerCase() != FirebaseAuth.instance.currentUser!.email!.toLowerCase()
                                                                            )
                                                              Padding(
                                                                padding:
                                                                    const EdgeInsets
  ...
  void _deleteFuncionario(items, BuildContext context, Usuario usuario,
      int position) async {
  ...
  void _navigateToFuncionarioInformation(
   ...
   void _navigateToFuncionario(
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => FuncionarioInformation( usuario: usuario,)),
    );
  }
