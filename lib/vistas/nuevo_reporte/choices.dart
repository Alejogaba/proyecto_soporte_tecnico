...
List<Map<String, dynamic>> serviceCategories = [
  {'value': 'reparacion - hardware', 'title': 'Reparación de hardware', 'brand': 'Hardware', 'body': 'Hardware'},
  {'value': 'actualizacion - componentes', 'title': 'Actualización de componentes', 'brand': 'Hardware', 'body': 'Hardware'},
  {'value': 'instalacion - software', 'title': 'Instalación de software', 'brand': 'Software', 'body': 'Software'},
  {'value': 'resolucion - problemas', 'title': 'Resolución de problemas', 'brand': 'Software', 'body': 'Software'},
  {'value': 'configuracion - redes', 'title': 'Configuración de redes', 'brand': 'Redes', 'body': 'Redes'},
  {'value': 'problemas - red', 'title': 'Solución de problemas de red', 'brand': 'Redes', 'body': 'Redes'},
  {'value': 'mantenimiento preventivo', 'title': 'Mantenimiento preventivo', 'brand': 'Mantenimiento', 'body': 'Otros'},
  {'value': 'otros', 'title': 'Otros', 'brand': 'Otros', 'body': 'Otros'},
];
