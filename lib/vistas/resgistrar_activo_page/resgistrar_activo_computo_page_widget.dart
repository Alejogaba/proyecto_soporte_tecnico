...
// for version 2 and greater youcan also use this
  ...
  _ResgistrarActivoPageWidgetState(this.operacionaRealizar, this.idSerial,
      this.idCategoria, this.activoEditar, this.listComponentesExActivosNull);
  ...
  Future<String> registrarActivo(
    ...
    Activo activoAguardar = Activo(
        nombre: textControllerNombre.text,
        detalles: textControllerDetalles!.text,
        urlImagen: imagenUrl,
        casosPendientes: false);
    String res = await activoController.addModActivo(
        context, activoAguardar, uidDependencia);
    return res;
  }
